...
describe UsersController do
  ...
  describe "POST 'create'" do
    ...
    describe "success" do
      ...
      it "should redirect to the user confirmation page" do
        post :create, :user => @attr
        response.should redirect_to new_email_confirmation_path
      end
  ...
  describe "PUT 'update'" do
    ...
    describe "failure" do
      ...
      it "should render the 'edit' page" do
        put :update, :id => @user.name, :user => @attr
  ...
  describe "follow pages" do
    ...
    describe "when signed in" do
      ...
      it "should show user followers" do
        get :followers, :id => @other_user.name
        response.should have_selector("a", 
                                      :href => user_path(@user),
                                      :content => @user.name)
      end
